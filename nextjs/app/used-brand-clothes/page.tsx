        ...
        <div className="min-w-0">
          ...
          <section className="mb-[3.5rem]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[2rem] items-center mb-[3rem]">
              ...
              <div className="rounded-[8px] overflow-hidden shadow-[0_8px_32px_rgba(0,0,0,0.14)] relative h-[280px]">
                <Image src="/images/clothes/adidas-kelme-athletic-shorts-pants-pile.webp" alt="RealismThrift Sorting Process Step 1 - Raw Material Collection and Initial Separation of Bulk Second-Hand Clothing" fill className="object-cover" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[2rem] items-center mb-[3rem]">
              <div className="rounded-[8px] overflow-hidden shadow-[0_8px_32px_rgba(0,0,0,0.14)] relative h-[280px] order-2 md:order-1">
                <Image src="/images/clothes/assorted-designer-hats-caps-collection.webp" alt="RealismThrift Quality Control Step 2 - Brand Identification and Authentication for Export Grade Clothes" fill className="object-cover" />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[2rem] items-center mb-[3rem]">
              ...
              <div className="rounded-[8px] overflow-hidden shadow-[0_8px_32px_rgba(0,0,0,0.14)] relative h-[300px]">
                <Image src="/images/clothes/mixed-fila-puma-tshirts-polo-shirts.webp" alt="RealismThrift Grading Standards Step 3 - Precise A B C Grade Selection for Wholesale Clothing Batches" fill className="object-cover" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[2rem] items-center mb-[2rem]">
              <div className="rounded-[8px] overflow-hidden shadow-[0_8px_32px_rgba(0,0,0,0.14)] relative h-[280px] order-2 md:order-1">
                <Image src="/images/clothes/athletic-track-jackets-lining-nike-stack.webp" alt="RealismThrift Export Logistics Step 5 - Hydraulic Compression Baling and Final QC for Global Shipment" fill className="object-cover" />
              </div>
              <div className="order-1 md:order-2">
                <div className="flex items-center gap-[0.875rem] mb-[1rem]">
                  <div className="w-[52px] h-[52px] bg-[#C0392B] rounded-full flex items-center justify-center shrink-0 shadow-[0_4px_16px_rgba(192,57,43,0.35)]">
          ...
          <section className="mb-[3rem]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[2rem] items-center">
              <div className="rounded-[8px] overflow-hidden shadow-[0_8px_32px_rgba(0,0,0,0.12)] relative h-[320px]">
                <Image src="/images/clothes/adidas-sport-shorts-pink-white-stripes.webp" alt="RealismThrift Typical Bale Composition - High-Quality Sorted Second-Hand Sportswear for Retail Resale" fill className="object-cover" />
              </div>
              <div>
          ...
          <section className="mb-[3rem]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-[1.25rem]">
              {[
                { title: 'Used Brand T-Shirts', img: '/images/clothes/champion-white-tshirt-green-script-logo.webp', desc: 'Nike, Adidas, Puma mix', spec: '25kg/bale' },
                { title: 'Used Brand Jeans', img: '/images/clothes/slim-fit-denim-jeans-classic-blue.webp', desc: "Levi's, Gap, Zara mix", spec: '45kg/bale' },
                { title: 'Used Brand Jackets', img: '/images/clothes/balenciaga-graffiti-denim-jacket-light-blue.webp', desc: 'North Face, Nike, Adidas', spec: '30kg/bale' },
                { title: 'Used Brand Dresses', img: '/images/clothes/lacoste-green-polo-dress-crocodile-logo.webp', desc: 'Zara, H&M, Mango mix', spec: '25kg/bale' },
                { title: 'Used Brand Hoodies', img: '/images/clothes/celine-black-hoodie-white-embroidered-logo.webp', desc: 'Champion, Nike, Adidas', spec: '35kg/bale' },
                { title: 'Used Brand Sportswear', img: '/images/clothes/nike-pro-dri-fit-croatia-jersey-stack.webp', desc: 'Nike, Adidas, Under Armour', spec: '30kg/bale' }
              ].map(prod => (
