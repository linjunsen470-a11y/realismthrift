...
export function getOrganizationSchema() {
  return {
    ...
    "description": "Dongguan Huihe Realismthrift Trading Co., Ltd. supplies sorted used clothes, shoes, and bags from China for wholesale importers and resale markets.",
    "foundingDate": "2012",
