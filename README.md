...
- **CMS Plan**: Sanity for the upcoming blog module
...
2. Install dependencies:
   ...
   pnpm install
   ```
3. Create a `.env.local` file and set the required values (see `.env.example`):
   ```env
...
## Project Structure
- `nextjs/`: Existing frontend application, including `app/`, `components/`, `data/`, `public/`, and build configuration.
- `sanity/studio-realismthrift/`: Sanity Studio project for blog content management.
