...
export const siteFooter: SiteFooter = {
  ...
  sections: [
    ...
    },
    {
      title: "Products",
      links: [
        { label: "Used Clothes", href: "/product-category/used-clothes" },
        { label: "Used Shoes", href: "/product-category/used-shoes" },
        { label: "Used Bags", href: "/product-category/used-bags" },
        { label: "Brand Shoes", href: "/products/used-brand-shoes" },
        { label: "Brand Clothes", href: "/products/used-brand-clothes" },
      ],
    },
  ],
  contact: {
